...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var DropDown = ({
    ...
    return /* @__PURE__ */ import_react.default.createElement("select", {
      ...
      disabled: true,
      selected: true
    }, name), selectableValues.map((x, i) => /* @__PURE__ */ import_react.default.createElement("option", {
      key: i,
      value: x
    }, x)), ";");
  };
  ...
  var formReducer = (state, action) => {
    switch (action.type) {
      ...
      case "FORM_SUBMIT":
        ...
        return {
          ...state,
          salaryAfterTaxes: calculateSalaryAfterTaxes(city, incomeYear, profession, experience),
          displayModal: true
        };
    }
  };
  ...
  var Card = ({ title, content }) => {
    if (!title || !content) {
      return null;
    }
    return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement("h2", null, title), /* @__PURE__ */ import_react3.default.createElement("p", null, content)));
  };
  ...
  var Form = () => {
    ...
    return /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, /* @__PURE__ */ import_react5.default.createElement("form", {
      ...
      selectableValues: ["Programmerare", "L\xE4rare", "Kassabitr\xE4de"],
      name: "Yrke",
      ...
      onChange: dispatch,
      entityKey: "city",
      selectableValues: ["Stockholm", "G\xF6teborg"],
      name: "Stad",
      testId: "city" /* City */
    }), /* @__PURE__ */ import_react5.default.createElement(DropDown, {
      ...
      content: `L\xF6n efter skatt: ${salaryAfterTaxes.toString()}`
    }));
  };
